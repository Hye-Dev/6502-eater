#ifndef __VIA1_UTILS_H
#define __VIA1_UTILS_H

// VIA1 register definitions (same as VIA_REGISTER_* but for direct access)
#define VIA1_REG_PORTB 0x00
#define VIA1_REG_PORTA 0x01
#define VIA1_REG_DDRB  0x02
#define VIA1_REG_DDRA  0x03
#define VIA1_REG_T1CL  0x04
#define VIA1_REG_T1CH  0x05
#define VIA1_REG_T1LL  0x06
#define VIA1_REG_T1LH  0x07
#define VIA1_REG_T2CL  0x08
#define VIA1_REG_T2CH  0x09
#define VIA1_REG_SR    0x0a
#define VIA1_REG_ACR   0x0b
#define VIA1_REG_PCR   0x0c
#define VIA1_REG_IFR   0x0d
#define VIA1_REG_IER   0x0e
#define VIA1_REG_PANH  0x0f

// Direct access to VIA1 registers as external variables
extern unsigned char VIA1_PORTB;
extern unsigned char VIA1_PORTA;
extern unsigned char VIA1_DDRB;
extern unsigned char VIA1_DDRA;
extern unsigned char VIA1_T1CL;
extern unsigned char VIA1_T1CH;
extern unsigned char VIA1_T1LL;
extern unsigned char VIA1_T1LH;
extern unsigned char VIA1_T2CL;
extern unsigned char VIA1_T2CH;
extern unsigned char VIA1_SR;
extern unsigned char VIA1_ACR;
extern unsigned char VIA1_PCR;
extern unsigned char VIA1_IFR;
extern unsigned char VIA1_IER;
extern unsigned char VIA1_PANH;

// Same flag definitions from via_utils.h for consistency
